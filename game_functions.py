...
def fire_bullet(ai_settings, screen, ship, bullets):
    """Fire a bullet if limi not reached yet"""
...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets):
    """Responds to keypressses and mouse clicks"""
...
def check_bullet_alien_collision(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # Remove to any bullets and aliens that have collided
    ...
    if len(aliens) == 0:
        # Destroy exisiting bullets, speed up game, and create new fleet.
...
def create_fleet(ai_settings, screen, ship, aliens):
    """Create a full fleet of aliends."""
...
def check_fleet_edges(ai_settings, aliens):
    """Responds appropriately if any aliens ahave reached an edge."""
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            ...
            ship_hit(ai_settings, screen, stats, sb, ships, alien, bullets)
            break
